<template>
  <div class="max-w-2xl mx-auto p-4">
    <h2 class="text-2xl font-bold mb-4">Publicaciones del Grupo</h2>
    ...
    <div v-else>
      ...
      <div v-else class="text-gray-500">No hay publicaciones en este grupo.</div>
    </div>
  </div>
</template>
...
const submitPost = async () => {
  ...
  try {
    ...
    await fetchPosts(); // Recargar publicaciones después de agregar
  } catch (error) {
